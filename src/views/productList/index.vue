<template>
  <div class="shop-list-link" ref="box">
    ...
    <van-tabs v-model="activeName" @click="chgFilmType" :class="{on:ison}" ref="list">
    <div class="abc">
       <van-tab title="综合" name="default">
        <ul>
          <router-link tag="li" :to="'/productDetail/'+list.sku_id" class="shop-link" v-for="list in ShopList" :key="list.sku_id">
